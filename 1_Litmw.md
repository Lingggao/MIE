...
学生们的学业和成绩至关重要，因此学生评估工作一般放在首位。学生评估，指通过循环收集与分析学生数据 (例如成绩等) 而为学生设定学业目标。零散、抽象的数据不能用于指导教育工作，Microsoft 推荐教师们借助 Excel (初级) 或 Power BI (高级) 等生产力工具，通过具体、透明、经过授权的方式收集、分析与共享数据。实体或虚拟数据墙通常可以起到显著的作用。
